...
Copyright (c) 2011-22 G. Peter Lepage.
...
setup(name='gvar',
    ...
    install_requires=['cython>=0.17', 'numpy>=1.16', 'scipy'] if USE_CYTHON else ['numpy>=1.16', 'scipy'],
    # for distutils (pip ignores):
    requires=['cython (>=0.17)', 'numpy (>=1.16)', 'scipy'] if USE_CYTHON else ['numpy (>=1.16)', 'scipy'],
