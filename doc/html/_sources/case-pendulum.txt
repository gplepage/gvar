...
factors: 1) the length of the pendulum (0.25m) can be adjusted  with a
precision of at best ±0.5mm; and 2) irregularities in  the drive mechanism
cause the maximum angle of swing (π/6) to fluctuate by ±0.025 |~| radians. The
challenge is to determine how these uncertainties affect time-keeping over a
day.
